				...
				Images: []*model.ImageDTO{
					{
						Image: &model.Image{
							...
							FileName:      "Suscipit Nulla Elit.jpg",
						},
						GID: "LkwzNLWkg",
						SID: "sPL_CSMzR2",
					},
					{
						Image: &model.Image{
							...
							FileName:      "Diam Cras Pellentesque Volutpat Dui.jpg",
						},
						GID: "LkwzNLWkg",
						SID: "sELljSMkgR",
					},
					{
						Image: &model.Image{
							...
							FileName:      "Nibh In Quis Justo.jpg",
						},
						GID: "LkwzNLWkg",
						SID: "yPL_jSMzR_",
					},
					...
					},
					{
						Image: &model.Image{
							...
							FileName: "Turpis Donec Posuere Metus.jpg",
						},
						GID: "LkwzNLWkg",
						SID: "sELljIGkR1",
					},
					{
						Image: &model.Image{
							...
							FileName:      "Pulvinar Nulla Pede.jpg",
						},
						GID: "LkwzNLWkg",
						SID: "yEL_CSGkgI",
					},
